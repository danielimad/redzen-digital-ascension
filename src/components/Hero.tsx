    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      <div className="container mx-auto px-6 text-center z-10">
        <div className="slide-in-bottom">
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-4 md:mb-6 text-glow leading-tight">
      ...
      <div className="absolute bottom-10 sm:bottom-20 right-4 sm:right-20 w-32 sm:w-48 h-32 sm:h-48 bg-neon-cyan/10 rounded-full blur-xl float-animation" style={{animationDelay: '2s'}}></div>
    </section>
  );
};
